...
**[GitHub Releases 페이지 →](https://github.com/contact993/corepeak/releases)** 에서 설치파일을 받으세요.
...
[이슈로 알려주세요](https://github.com/contact993/corepeak/issues/new/choose).
:::
...
Corepeak은 **광고 없는 100% 무료**입니다. 도움이 되셨다면 두 가지가 도구를 살립니다:

- **[GitHub에서 Star →](https://github.com/contact993/corepeak)** — 도구가 실제로 쓰인다는 가장 강한 신호입니다.
- **[논문에 인용 →](/corepeak/ko/cite/)** — 인용은 무료 학술 도구의 지속 개발을 정당화합니다.
